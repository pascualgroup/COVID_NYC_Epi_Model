---
title: "SEIR Hyrbid Model with 1 Pre-Symptomatic Compartment: Pre-Symp and Asymp have same rate with Presymp occuring before Asymp/Symp split No Asymp Tranmission only Pre-Symptomatic"
...
p = ggplot(data = comp_data_melt) +
  ...
  ylab("S over N")
p
png("../Figures/Profiles/N_13_Model/Small_E_0_param_S_over_N.png")
print(p)
dev.off()
```
...
p = ggplot(data = select_trajectories,
  ...
  sim_traj_scale
p
png("../Figures/Profiles/N_13_Model/MIF_Run_1/Specific_traj_S_over_N_small_p_S_comb.png")
print(p)
dev.off()
```
...
p = ggplot(data = comp_data_melt) +
  ...
  ylab("R over N")
p
png("../Figures/Profiles/N_13_Model/Small_p_S_param_R_over_N.png")
print(p)
dev.off()
```
...
p = ggplot(data = select_trajectories,
  ...
  sim_traj_scale
p
png("../Figures/Profiles/N_13_Model/MIF_Run_1/Specific_traj_R_over_N_small_p_S_comb.png")
print(p)
dev.off()
```
...
p
png("../Figures/Profiles/N_13_Model/Small_p_S_param_R_over_N_vs_anitbody_test.png")
print(p)
dev.off()
```
