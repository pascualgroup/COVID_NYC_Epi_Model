---
title: "Combine Profile Outputs Fit to Sim Data Big b_a Parameter Combination"
...
for(param_index in seq(1:midway_max_jobs)){
  ...
  input_file_name = paste0("../Generated_Data/Profiles/", model_name,
                           "_Model/",profile_var,"_Profile_Sim_Data_Big_b_a_param/Subset_Outputs/",profile_var,
                           "_", model_name,
               "_Profile_Sim_Data_Big_b_a_param_subset_",param_index,".RData")
...
output_file_name = paste0("../Generated_Data/Profiles/", model_name,"_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/",
                          profile_var, "_", model_name, "_profile_Sim_Data_Big_b_a_param_combined_data_including_traces_and_start.RData")
...
output_file_name = paste0("../Generated_Data/Profiles/", model_name,"_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/",
                          profile_var, "_", model_name, "_profile_Sim_Data_Big_b_a_param_combined_data.csv")
...
p = ggplot(data = profile_data_clean, aes_string(x = eval(profile_var), y = "loglik")) + geom_point() + geom_hline(yintercept = cutoff_thres_20_LL_from_ML,
  ...
  rahul_theme
print(p)
png(paste0("../Figures/Profiles/", model_name, "_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/all_clean_data_points_",
           profile_var,"_", model_name, "_profile_Sim_Data_Big_b_a_param.png"))
print(p)
dev.off()
...
print(p)
png(paste0("../Figures/Profiles/", model_name, "_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/full_",
           profile_var, "_", model_name, "_profile_Sim_Data_Big_b_a_param.png"))
print(p)
dev.off()
...
png(paste0("../Figures/Profiles/", model_name, "_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/20_LL_from_ML_",
           profile_var, "_", model_name, "_profile_Sim_Data_Big_b_a_param.png"))
print(p)
dev.off()
}
...
```{r}
profile_var = "b_a"
profile_data= read.csv(file = paste0("../Generated_Data/Profiles/", model_name, "_Model/", profile_var, "_Profile_Sim_Data_Big_b_a_param/",
                          profile_var, "_", model_name, "_profile_Sim_Data_Big_b_a_param_combined_data.csv"))
...
save(profile_peak_data_b_a, file = paste0("../Generated_Data/Profiles/",
     model_name,
     "_Model/b_a_Profile_Sim_Data_Big_b_a_param/top_2_LL_of_b_a_profile_Sim_Data_Big_b_a_param.RData"))
...
png("../Figures/Profiles/N_12_Model/b_a_Profile_Sim_Data_Big_b_a_param/p_S_vs_log_R_0_b_a_Profile_Sim_Data_Big_b_a_param_data.png")
print(p)
dev.off()
...
p = ggplot(data = profile_peak_data,
  ...
  rahul_theme
p
png("../Figures/Profiles/N_12_Model/b_a_Profile_Sim_Data_Big_b_a_param/b_a_vs_log_R_0_b_a_Profile_Sim_Data_Big_b_a_param_data.png")
print(p)
dev.off()
...
### b_a profile peak
```{r}
source("Sim_b_a_profile_peak_Model_N_12_Sim_data_big_b_a_param.R")
```
